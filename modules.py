	...
	def __init__(self, size_space:Union[int, tuple, list])->NoReturn:
		...
		if isinstance(size_space, int):
			...
			if len(size_space) == 1:
				...
				raise RuntimeError(f'Can\'t create \'{type(self).__name__}\'.'
...
class Border(Padding):
	...
	def __init__(self, border_widths:Union[int,list,tuple],
				colors:Union[list,tuple],
				parent:pygame.sprite.Sprite)->NoReturn:
		"""Summary
...
class FontProperty:
	...
	def __init__(self, font_name:str=None, font_size:int=None,
				font_color:Union[list,tuple]=None)->NoReturn:
		"""Summary
...
class SizeRange:
	...
	def __init__(self, min_width:int, max_width:int,
				min_height:pygame.sprite.Sprite, max_height:int)->NoReturn:
		"""Summary
...
if __name__ == '__main__':
	col = [[[100, 20, 30], [30, 20, 100]]]
	bord = Border(3, col, None)
	for l, c in bord:
		print('line', type(l), l)
		print('color', type(c), c)
